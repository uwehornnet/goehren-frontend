            ...
            <main>
                ...
                <div className="w-full bg-slate-100 aspect-video flex flex-column items-end">
                    <div className="container mx-auto py-16">
                        <h2 className="text-2xl font-semibold mb-4">
                            Hinaus auf die Ostsee ohne nass zu werden <br /> -
                            Die Seebrücke im Ostseebad Göhren
                        </h2>
                        <p className="max-w-[400px]">
                            Am Nordstrand, neben dem Kurplatz, befindet sich die
                            280 Meter lange Seebrücke Göhrens
                        </p>
                        <Link href="/">
                ...
                <div className="container mx-auto my-16">
                    <div className="max-w-[800px]">
                        <h2 className="text-2xl font-semibold mb-4">
                            Erleben, Entspannen, Genießen oder Action? <br />{" "}
                            Natürlich im Ostseebad Göhren.
                        </h2>
                        <p>
                            I'm baby umami farm-to-table shoreditch leggings,
                            crucifix VHS forage ennui small batch four dollar
                            toast cray. Shaman gentrify live-edge DIY salvia,
                            blog cardigan schlitz whatever la croix post-ironic
                            art party gastropub. Taiyaki truffaut trust fund
                            pitchfork, taxidermy disrupt kinfolk.
                        </p>
                    </div>
                </div>
                {/** Textcontent End */}
                ...
                <div className="container mx-auto grid grid-cols-3 gap-4 my-16">
                    <div className="col-span-1 aspect-square bg-slate-100 p-8 flex flex-col justify-between">
                        ...
                        <div>
                            <p>
                                I'm baby umami farm-to-table shoreditch
                                leggings, crucifix VHS forage ennui small batch
